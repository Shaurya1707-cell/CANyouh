...
const AboutUs = () => {
  ...
  return (
    <section id="about-us" className="section-padding bg-brand-cream overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="font-body text-muted-foreground text-lg mt-4 max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          >
            <div className="absolute -top-24 -right-24 w-56 h-56 rounded-full bg-primary/15 blur-3xl" />
            ...
            <div className="relative">
              ...
              <div className="mt-8 inline-flex items-center gap-2 rounded-full bg-background/70 backdrop-blur border border-border/50 px-4 py-2">
          ...
          >
            ...
            <div className="glass-card-hover p-6 bg-secondary text-secondary-foreground border border-secondary/30">
